...
const PROMPT = "Checkout actions overflow off-screen on mobile.";
const KNOWN_BAD_SOURCE_FILES = [
  "src/routes/mobile-overflow.tsx",
  "src/routes/mobile-overflow.css",
  "src/App.tsx",
] as const;

export async function createMobileOverflowScenario(
  ...
  return scenarioManifestSchema.parse({
      ...
      predicates: [
        {
          ...
          desktopViewport: { width: 1280, height: 720, deviceScaleFactor: 1 },
          tolerancePx: 2,
        },
      ],
    },
    ...
    codeOracle: {
      scopedPaths: ["src/routes/mobile-overflow.css"],
